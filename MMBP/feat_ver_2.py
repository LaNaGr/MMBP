...
class feature:
    def __init__(self, instances):
        ...
        features, dynamic
            ope:
                ...
                Job completion time
                Start time
                release_time    ## new feature
                due_time        ## new feature
            ma:
        ...
        self.feat_paras = {"ope_feat_dim": 8, "ma_feat_dim": 3}
    ...
    def set_release_and_due_time(self, release_time_matrix, due_time_matrix):
        self.feat_opes_batch[:, 6, :] = release_time_matrix
        self.feat_opes_batch[:, 7, :] = due_time_matrix
